...
DATA_DIR = "/home/nipopovic/Projects/hl_task_prediction/big_storage/data_sets_shortcut/ImageNet/2012-1k"
MODEL = "resnet34"
B_SIZE = 8 # 256
CHECKPOINT = "/srv/beegfs02/scratch/hl_task_prediction/data/nikola/experiment_logs/tmp/20210423-205156-resnet34/last.pth.tar"
...
parser.add_argument('--eps', default=EPS, type=float, metavar='N',
...
parser.add_argument('--model', '-m', metavar='NAME', default=MODEL,
                    help='model architecture (default: dpn92)')
parser.add_argument('-j', '--workers', default=N_WORKERS, type=int, metavar='N',
                    help='number of data loading workers (default: 2)')
parser.add_argument('-b', '--batch-size', default=B_SIZE, type=int,
